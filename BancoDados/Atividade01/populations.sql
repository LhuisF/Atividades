...
insert into orders(id_orders, id_table, id_clientes, dates, status) values (1, 1, 2, '2025-03-29', 'aberto');
insert into orders(id_orders, id_table, id_clientes, dates, status) values (2, 3, 1, '2025-03-01', 'aberto');

--Adição de dados na tabela productsches
insert into productsches(id_orders, id_products, quantitys) values (1, 3, 1);
insert into productsches(id_orders, id_products, quantitys) values (1, 2, 2);
insert into productsches(id_orders, id_products, quantitys) values (2, 1, 1);